...
function generatePage(page) {
  ...
  for (let i = start; i < end; i++) {
    ...
    // for (let i = 0; i < data.length; i++)
    displayhtml += "<tr>";
    displayhtml += "<td>" + data[i].userId + "</td>";
    displayhtml += "<td>" + data[i].id + "</td>";
    displayhtml += "<td>" + data[i].title + "</td>";
    displayhtml += "<td>" + data[i].body + "</td>";
    displayhtml += "</tr>";
  }
  console.log(displayhtml);
  document.getElementById("data").innerHTML = displayhtml;
